...
class _ArtistDetailPageState extends State<ArtistDetailPage> {
  ...
  Future<void> _fetchAlbums() async {
    ...
    try {
      ...
      if (mounted) setState(() { _albums = albums; _loadingAlbums = false; });
    } catch (_) {
      if (mounted) setState(() => _loadingAlbums = false);
    }
  }
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: _buildAlbumSection(context, subsonic, accentColor)),
  ...
  Widget _buildAlbumSection(
    ...
    return _AlbumRow(albums: albums, subsonic: subsonic, accentColor: accentColor);
  }
}
